...
var productInfo = [
    ...
    {
        name: "Gold-Tone Flower Drop Earrings",
    ...
    {
        name: "Petite Stretch Crepe Wrap Skirt",
    ...
    {
        name: "Mix and Match Flower Tulle Skirt",
    ...
    },
    {
        ...
        price: 60,
        description: "Athletes, artists, experimenters, rebels and visionaries have all turned to the vintage, sporty style of the Pumpkin Juice Hi Casual Sneakers. Designed with simplicity and style in mind, these shoes feature a rugged canvas upper that conforms to each foot, plus a durable rubber outsole that can handle whatever your day contains."
    },
    {
        name: "Mr. Sparten's",
        image: "/images/docs.png",
        price: 125,
        description: "Iconic's classic smooth leather is durable and famously stiff to start with; it molds to your feet and gets more comfortable with wear. Smooth leather can be polished to a dapper shine, or artfully scuffed up, depending on your preference."
    },
    {
        name: "Leather Oxfords",
        image: "/images/oxford.png",
        price: 95,
        description: "Chirag Shah focuses on both comfort and style with the smooth look of these classic bicycle-toe Oxfords."
    },
    {
        name: "Platform Pumps",
        image: "/images/platform.png",
        price: 69,
        description: "Iconic's Parade pumps stylishly bring you from the office to a night out with a subtle pointed toe and retro-inspired platform heel."
    },
    {
        name: "Simon Child's Casual Sneakers",
        image: "/images/sneaker.png",
        price: 50,
        description: "The Simon Child was introduced in 1969 as the first low-top basketball sneaker to feature an all-leather upper and the now famous rubber shell toe."
    },
    {
        name: "Chelsea Boots",
        image: "/images/threeQuarter.png",
        price: 100,
        description: "Tread confidently in the bold, burnished style of Okan Benn's Chelsea boots."
    },
    {
        name: "Wedge Booties",
        image: "/images/wedge.png",
        price: 99,
        description: "A chic covered wedge heel and fashion-forward fold-over cuff add a confident finish to jeans and skirts in Okan Benn ankle booties."
    },
    {
        name: "Contrast-Trim Blazer",
    ...
    {
        name: "Slim-Fit Jersey Sport Coat",
    ...
    {
        name: "Grecian-Style Pleated Dress",
    ...
    {
        name: "Crew-Neck Layering Long Sleeve Tee for Women",
    ...
    },
    {
        ...
        price: 25,
        description: "This all-purpose top features a particularly feminine, curve-hugging cut by Monica Gomez."
    },
    {
    ...
    {
        name: "Men's Slim-Fit Button Down Shirt",
